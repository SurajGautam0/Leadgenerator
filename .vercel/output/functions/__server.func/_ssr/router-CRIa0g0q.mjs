...
import { n as auth } from "./server-BRP8TwDG.mjs";
import { n as TriangleAlert } from "../_libs/lucide-react.mjs";
import { t as QueryClient } from "../_libs/tanstack__query-core.mjs";
import { t as Toaster } from "../_libs/sonner.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/router-CRIa0g0q.js
...
function AppProviders({ children }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(QueryClientProvider, {
		...
		children: [children, /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Toaster, {
			...
			toastOptions: { className: "font-sans! border-border! bg-card! text-fg! shadow-[var(--shadow-lift)]!" }
		})]
	});
}
var styles_default = "/assets/styles-aSWQrLhf.css";
var APP_NAME = "Alba";
...
var Route$4 = createRootRoute({
	...
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Alba maps scored households for a cleaning studio — location, name, email, and pipeline in one private book."
			},
			{
				name: "theme-color",
				content: "#2a3a34"
...
var $$splitComponentImporter$2 = () => import("./routes-CwvGAhg1.mjs");
var Route$3 = createFileRoute("/")({ component: lazyRouteComponent($$splitComponentImporter$2, "component") });
var $$splitComponentImporter$1 = () => import("./login-CAfKYk7p.mjs");
...
var $$splitComponentImporter = () => import("./studio-C2qUT7Tz.mjs");
